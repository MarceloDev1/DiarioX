...
namespace DiarioX.Server.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260926053315_AddFaturamentoPlataforma")]
    partial class AddFaturamentoPlataforma
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiarioX.Server.Domain.Entities.Assinatura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("AsaasClienteId")
                        ...
                        .HasColumnName("asaas_cliente_id");
                    ...
                    b.HasIndex("TenantId")
                        .IsUnique()
                        .HasDatabaseName("IX_assinaturas_tenant");

                    b.ToTable("assinaturas", null, t =>
                        {
                            t.HasCheckConstraint("CK_assinaturas_desconto", "desconto_percentual BETWEEN 0 AND 100");

                            t.HasCheckConstraint("CK_assinaturas_dia_vencimento", "dia_vencimento BETWEEN 1 AND 28");
            ...
            modelBuilder.Entity("DiarioX.Server.Domain.Entities.FaturaAssinatura", b =>
                {
                    ...
                    b.Property<int>("AlunosAtivos")
                        .HasColumnType("integer")
                        .HasColumnName("alunos_ativos");
                    ...
                    b.Property<string>("NotaFiscalErro")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("nota_fiscal_erro");
                    ...
                    b.Property<string>("NotaFiscalNumero")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("nota_fiscal_numero");

                    b.Property<string>("NotaFiscalPdfUrl")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("nota_fiscal_pdf_url");

                    b.Property<string>("NotaFiscalSituacao")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("nota_fiscal_situacao");
                    ...
                    b.Property<decimal>("ValorPorAluno")
                        .HasPrecision(12, 2)
                        .HasColumnType("numeric(12,2)")
                        .HasColumnName("valor_por_aluno");
                    ...
                    b.HasIndex("AsaasCobrancaId")
                        .HasDatabaseName("IX_faturas_assinatura_asaas_cobranca");

                    b.HasIndex("NotaFiscalId")
                        .HasDatabaseName("IX_faturas_assinatura_nota_fiscal");
                    ...
                    b.ToTable("faturas_assinatura", null, t =>
                        {
            ...
            modelBuilder.Entity("DiarioX.Server.Domain.Entities.PlanoAssinatura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("Nome")
                        .IsUnique()
                        .HasDatabaseName("IX_planos_assinatura_nome");

                    b.ToTable("planos_assinatura", null, t =>
                        {
                            t.HasCheckConstraint("CK_planos_assinatura_valores", "valor_fixo >= 0 AND valor_por_aluno >= 0 AND valor_minimo >= 0");
                        });
                });
            ...
            modelBuilder.Entity("DiarioX.Server.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.ToTable("tenants", null, t =>
                        {
                            t.HasCheckConstraint("CK_tenants_situacao_financeira", "situacao_financeira IN ('REGULAR', 'EM_ATRASO', 'SOMENTE_LEITURA')");
            ...
            modelBuilder.Entity("DiarioX.Server.Domain.Entities.Assinatura", b =>
                {
                    b.HasOne("DiarioX.Server.Domain.Entities.PlanoAssinatura", "Plano")
                        .WithMany()
                        .HasForeignKey("PlanoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DiarioX.Server.Domain.Entities.Tenant", "Tenant")
                        .WithMany()
                        .HasForeignKey("TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
