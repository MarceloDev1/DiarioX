...
- Crie um projeto react com create-vite: `npm init --yes vite@latest diariox.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Criar o arquivo de projeto (`diariox.client.esproj`).
