...
export default defineConfig(({ command }) => {
    // Only generate the ASP.NET dev certificate when running the dev server.
    // During production builds (CI / Docker / Railway) `dotnet` is not
    // available and HTTPS is not needed for the build output.
